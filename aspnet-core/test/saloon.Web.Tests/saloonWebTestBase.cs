...
{
    public abstract class saloonWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static saloonWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(saloonWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<saloonDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<saloonDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<saloonDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<saloonDbContext, Task<T>> func)
        {
            T result;
